...
module.exports = (survey) => {
    ...
    <! Second Row with Two Columns--> 
      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="10px" width="100%" style="padding: 30px 30px 30px 60px;">
              <tr>
                <td> <form> <a href="${keys.redirectDomain}/api/surveys/${survey.id}/yes" class="button" role="button">
                      Yes
                  </a> </form> </td> 
                  <td> <form> <a href="${keys.redirectDomain}/api/surveys/${survey.id}/no" class="button" role="button">
                  No
                </a> </form> </td> 
